...
class TestConfig1:
    ...
    def test_sections_meta(self, model_config1):
        expected = pd.read_csv("sbat/tests/data/example1/sections_meta.csv", index_col=0)
...
class TestConfig3:
    ...
    def test_sections_meta(self, model_config3):
        expected = pd.read_csv("sbat/tests/data/example3/sections_meta.csv", index_col=0)
